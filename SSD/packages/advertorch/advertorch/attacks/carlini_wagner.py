...
class CarliniWagnerL2Attack(Attack, LabelMixin):
    ...
    def _is_successful(self, output, label, is_logits):
        ...
        # print(is_successful(pred, label, self.targeted))
        # exit()
    ...
    def _update_loss_coeffs(
        ...
        print(labs.shape, cur_labels.shape, batch_size, loss_coeffs.shape, coeff_upper_bound.shape, coeff_lower_bound.shape)
        exit()
    ...
    def perturb(self, x, y=None):
        ...
        for outer_step in range(self.binary_search_steps):
            ...
            for ii in range(self.max_iterations):
                ...
                #print(delta.shape, y_onehot.shape, loss_coeffs.shape)
                #exit()
