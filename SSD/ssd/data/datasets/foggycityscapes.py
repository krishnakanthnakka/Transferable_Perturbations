...
class FOGGYCITYSCAPESDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        ...
        self.ids = FOGGYCITYSCAPESDataset._read_image_ids(image_sets_file)
    ...
    def __getitem__(self, index):
        ...
        image = self._read_image(image_id, self.beta)
    ...
    def _read_image(self, image_id, beta):
        image_file = os.path.join(
            self.data_dir, "JPEGImages", "{}.png".format(image_id))
