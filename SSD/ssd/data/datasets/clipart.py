...
class CLIPARTDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        ...
        self.data_dir = '/cvlabdata1/home/krishna/DA/cross-domain-detection/datasets/clipart/'

        image_sets_file = os.path.join(
            self.data_dir, "ImageSets", "Main", "%s.txt" % self.split)
        self.ids = CLIPARTDataset._read_image_ids(image_sets_file)
