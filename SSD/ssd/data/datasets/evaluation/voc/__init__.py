...
def voc_evaluation(dataset, predictions, output_dir, iteration=None, num_images=-1):
    ...
    if iteration is not None:
        result_path = os.path.join(
            output_dir, 'result_{:07d}.txt'.format(iteration))
    else:
        result_path = os.path.join(output_dir, 'result_{}.txt'.format(
