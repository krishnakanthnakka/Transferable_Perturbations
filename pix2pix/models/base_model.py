...
class BaseModel(ABC):
    ...
    def setup(self, opt):
        ...
        if not self.isTrain or opt.continue_train:
            ...
            self.load_networks(load_suffix, opt.detcfg.OUTPUT_DIR)
    ...
    def load_networks(self, epoch, save_dir):
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                logger.info('Loading the model from {}'.format(load_path))
                ...
                if 'model_state_dict' not in state_dict.keys():
                    net.load_state_dict(state_dict)

                else:
                    net.load_state_dict(state_dict['model_state_dict'])
                # self.optimizer_G.load_state_dict(state_dict['optimizer_state_dict'])
