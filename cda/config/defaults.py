...
_C.EVAL_MODEL = CN()
_C.EVAL_MODEL.EVAL_DIFFERENT_MODEL_FROM_TRAIN = False
_C.EVAL_MODEL.META_ARCHITECTURE = ''
_C.EVAL_MODEL.NUM_CLASSES = 21
_C.EVAL_MODEL.DEVICE = "cuda"
_C.EVAL_MODEL.BACKBONE = CN()
_C.EVAL_MODEL.BACKBONE.NAME = 'vgg'
_C.EVAL_MODEL.BACKBONE.OUT_CHANNELS = (512, 1024, 512, 256, 256, 256)
_C.EVAL_MODEL.BACKBONE.PRETRAINED = True  # CHANGED not to load pretrained
...
_C.MODEL.BACKBONE.PRETRAINED = True  # CHANGED not to load pretrained
...
# ---------------------------------------------------------------------------- #
_C.NETG = CN()
_C.NETG.PERTURB_MODE = False
_C.NETG.EPS = 0.03921568627
#
