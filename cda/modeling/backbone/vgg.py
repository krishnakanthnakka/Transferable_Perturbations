...
def vgg(cfg, pretrained=True):
    ...
    # print(model.vgg)
    # for idx, m in enumerate(model.vgg.modules()):
    #     if isinstance(m, nn.Conv2d):
    #         print(idx, m.weight)
    #         break
    # for idx, m in enumerate(model.modules()):
    #     for idx2, m1 in enumerate(m.modules):
    #         print(idx2, m1)
    #         exit()

    # print(model.vgg.layer)
    # exit()

    if pretrained:
        # exit()
        print("loading from pretrained downloaded model")
