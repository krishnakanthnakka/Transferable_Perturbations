...
from cda.modeling.box_head.box_predictor import make_box_predictor
from cda.utils import box_utils
...
class SSDBoxHead(nn.Module):
    ...
    def forward_without_postprocess(self, features, targets=None, softmax=False):
        cls_logits, bbox_pred = self.predictor(features)
        cls_logits = F.softmax(cls_logits, dim=2)
