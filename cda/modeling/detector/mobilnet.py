...
from cda.modeling.detector.miscops import ConvNormActivation, SqueezeExcitation as SElayer
import logging
...
def _mobilenet_v3_model(
    ...
    **kwargs: Any
    ...
    if pretrained:
        ...
        state_dict = load_state_dict_from_url(model_urls[arch],"./pretrained/", progress=progress)
...
def mobilenet_v3_large(pretrained: bool = False, progress: bool = True, act_layer: List[int] = -1, act_layer_mean: bool = False, **kwargs: Any) -> MobileNetV3:
    """
