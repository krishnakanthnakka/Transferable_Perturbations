...
def _load_pretrained(model_name: str, model: nn.Module, progress: bool) -> None:
    ...
    model.load_state_dict(
        load_state_dict_from_url(checkpoint_url, "./pretrained/", progress=progress))
    logger = logging.getLogger("CDA.inference")
    logger.info("Loading {} model pretrained on Imagenet".format(model_name))
...
def mnasnet1_0(pretrained: bool = False, progress: bool = True, act_layer: List[int] = -1, act_layer_mean: bool = False, **kwargs: Any) -> MNASNet:
